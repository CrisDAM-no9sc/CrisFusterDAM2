...
class Persona:
    def __init__(self, nuevonombre, nuevosapellidos, nuevaedad, nuevoemail, nuevadireccion):
...
personas.append(Persona("Carlos","Cifuentes Gonzalez",30,'carlos@correo.com','Calle carlos 1'))
personas.append(Persona("Manolo","Solis García",28,'manolo@solis.com','Avenida manuel 16'))
