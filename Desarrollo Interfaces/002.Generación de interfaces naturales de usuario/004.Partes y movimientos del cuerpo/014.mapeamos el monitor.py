...
##y estas son las resoluciones de nuestra pantalla
anchura = 1366
altura = 768
##aqui tenemos que dividirlo por la dimension de la ventana que aparece en la camara.
factorx = anchura/640
factory = altura/480
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                ############################### aqui es para mover el cursor por toda la pantalla ######################
                ...
                if contador % 10 == 0:
                    ...
                    pyautogui.moveTo(1366- x_pixel*factorx, y_pixel*factory)  
