...
window.onload = function(){
    ...
    //let graficoBarras = new GeneradorGrafica(datos, "#20B2AA", "table tbody");
    // Llamar al método para generar la gráfica de pastel
    graficoPastel.creargrafica();
    
    // Llamar al método para generar la gráfica de barras
   // graficoBarras.creargraficabarras();
    graficoPastel.creargrafica();
    //graficoBarras.creargraficabarras();
    graficoPastel.creargrafica();
    graficoPastel.creargrafica();
