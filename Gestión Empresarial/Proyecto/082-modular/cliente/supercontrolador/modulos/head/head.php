...
<html lang="es">
  <head>
    ...
    <meta charset="utf-8">
    <!-- Enlace a las hojas de estilo (CSS) en el <head> -->
...
<script><?php echo file_get_contents("modulos/head/head.js"); ?></script>
<style><?php echo file_get_contents("modulos/head/head.css"); ?></style>