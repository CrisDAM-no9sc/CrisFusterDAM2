    ...
    fetch("../../servidor/?o=columnastabla&tabla="+tabla)                 
        ...
        .then(datos => {
            ...
            datos.forEach(function(dato){      
                ...
                /////////// vamos a empezar con la barra de buscar
            ...
            elemento.onclick = function(){
                ...
                console.log("Recolectamos todos los campos")
                mensaje = {}
                campos_busqueda.forEach(function(campo){
                    let columna = campo.getAttribute("placeholder");
                    let valor = campo.value;
                    
                    //si valor no es igual a nada 
                    if(valor != ""){
                        //solo nos va a devolver los campos que estsen pedidos
                ...
                ///////////////////////// aqui hemos copiado y pegado el mismo trozo de codigo que en contenido tabla///////
                .then(datos => {
