...
class conexionBD{
	...
	public function seleccionaTabla($tabla){	
        	//ejecutamos consulta para ver que campos tienen restricciones							
        $query = "
            SELECT 
                *
            FROM 
        ...
        //creamos un array vacio para guardar las restriccioens							
        $restricciones = [];		
        // Iteramos sobre cada fila del resultado de la consulta																		
        while ($row = mysqli_fetch_assoc($result)) {
            // Añadimos cada fila (como un array asociativo) donde las claves son los nombres de las columnas.								
            $restricciones[] = $row;																			
        }
        // Mostramos el contenido del array de restricciones
    ...
    /////////////////////////////////   METODOS PARA LISTAR COLUMNAS DE LAS TABLAS /////////////////////////////////////

    public function columnasTablas($tabla){
