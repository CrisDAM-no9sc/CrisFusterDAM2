...
function cargaDatosTabla(tabla) {
    ...
    fetch("../../servidor/?o=columnastabla&tabla=" + tabla) 
        ...
        .then((datos) => {
            ...
            // Por si acaso hay columnas previamente cargadas, vacío la cabecera 
            ...
            boton_enviar.onclick = function () {
                ...
                .then(function(datos) {
                    console.log(datos);
                    document.querySelector("#modal").style.display = "none"; // Cambié esto para cerrar el modal correctamente
                });
            };
            ...
            fetch("../../servidor/?o=tabla&tabla=" + tabla) // Llamar al microservicio para obtener los datos de la tabla
                .then((response) => {
                    return response.json();
                })
                .then((datos) => {
                    ...
                    datos.forEach(function (registro) {
                        ...
                        nuevacolumna.onclick = function () {
                            ...
                            fetch("../../servidor/eliminar.php?tabla=" + tabla + "&id=" + identificador) // Llamada para eliminar el registro
                                .then(() => this.parentElement.remove()); // Eliminar visualmente la fila
                        };
