...
class conexionDB{
    ...
    ////////////////////////////////////////////  ACTUALIZAR SOLO UN CAMPO DE LA TABLA //////////////////////////////////////////

    public function actualizar($datos){
        $query = "
            UPDATE ".$datos['tabla']."                              --cojemos el nombre de la tabla        
            SET ".$datos['columna']." = '".$datos['valor']."'       --cojemos el nombre de la columna y el valor que hemos ingreasdo
            
            WHERE Identificador = ".$datos['Identificador']."       --con su identificador
        ";																											
        //echo $query;
        $result = mysqli_query($this->conexion , $query);	
        //y retornamos una cadena vacia 					
