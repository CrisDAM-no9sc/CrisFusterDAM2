/////////////////////////////////// CREAMOS VBARIABLE GLOBALES   /////////////////////////////////////////////
//creamos esta variable ara guardar las columnas
var columnas = [];
...
window.onload = function() {
  ...
  ///////////////////////// VENTANA MODAL ////////////////////////////
    ...
    // Si el usuario hace clic en cualquier lugar del modal, lo oculta
...
function cargaDatosTabla(tabla) {
  ...
  fetch("../../servidor/columnas_tabla.php?tabla=" + tabla) 
      ...
      .then(datos => {
        //vacia las columnas al cambiar de tabla 
        columnas = [];
          ...
          ///Cremoas casillas donde sale la informacion de cada casilla 
          columnas.forEach(function(columna){

            // Crear un contenedor para cada par de <p> e <input>
            ...
            inputContainer.appendChild(texto); // Añadir <p> al contenedor

            // Crear y añadir el campo de entrada
            let campo = document.createElement("input");
            campo.setAttribute("placeholder", columna);
            inputContainer.appendChild(campo); // Añadir <input> al contenedor
