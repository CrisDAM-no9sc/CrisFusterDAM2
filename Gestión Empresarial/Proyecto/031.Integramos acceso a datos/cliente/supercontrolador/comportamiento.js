...
function cargaDatosTabla(tabla) {
  ...
  fetch("../../servidor/viejo/columnas_tabla.php?tabla=" + tabla) 
    ...
    .then((datos) => {
      ...
      fetch("../../servidor/viejo/datos_tabla.php?tabla=" + tabla) // Llamar al microservicio para obtener los datos de la tabla
        .then((response) => {
          return response.json();
        })
        .then((datos) => {
